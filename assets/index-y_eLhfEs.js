...
`,HS=L.iframe`
  ...
  margin: 1rem 0;
`,WS=()=>$.jsxs(VS,{children:[$.jsxs(BS,{href:xf,target:"_blank",children:[$.jsx(US,{height:"100%"}),$.jsx(_c,{$align:"center",children:"open in new tab"})]}),$.jsx(HS,{src:xf,width:"650rem",height:"900rem",title:"Dillon Scott CV",allowFullScreen:!0})]}),Ef=[{title:"home",element:$.jsx(OS,{})},{title:"experience",element:$.jsx(FS,{})},{title:"projects",element:$.jsx(MS,{})},{title:"cv",element:$.jsx(WS,{})}],G0={defaultProps:Lo`
    transition-duration: 0.5s;
  `,titleFont:"DM Sans",bodyFont:"Gothic A1"},K0={background:"#232244",text:"#FFFFFF",text2:"#F4D6CC",accent:"#FFC933",accent2:"#A6E1FA",...G0},GS={background:"#FCF0EE",text:K0.background,text2:"#542111",accent:"#DA1643",accent2:"#5465FF",...G0},KS=L.main`
  ${e=>e.theme.defaultProps}
...
`,tk=()=>{var s;const[e,t]=P.useState("home"),[n,r]=P.useState(window.matchMedia("(prefers-color-scheme: dark)").matches),i=SS();return $.jsxs(_y,{theme:n?K0:GS,children:[$.jsx(ek,{}),$.jsxs(qS,{children:[$.jsx(JS,{children:Ef.map(({title:o,element:a},l)=>$.jsx(YS,{$active:o===e,children:$.jsx(QS,{onClick:()=>t(o),$title:o,$active:o===e,children:o})},o))}),$.jsx(XS,{$checked:n,"aria-label":`Turn ${n?"off":"on"} dark mode`,id:"theme-label",children:$.jsx(ZS,{onClick:()=>r(o=>!o),"aria-labelledby":"theme-label"})})]}),$.jsx(aa.Provider,{value:i,children:$.jsx(KS,{children:(s=Ef.find(({title:o})=>o===e))==null?void 0:s.element})})]})};Qa.createRoot(document.getElementById("root")).render($.jsx(Ie.StrictMode,{children:$.jsx(tk,{})}));
